...
const ApplyForm = () => {
  ...
  return (
    <>
      <div className="my-10">
        <h3 className="font-bold text-lg md:text-4xl text-center">
          Apply form for {college?.college_name}
        </h3>
        <form
          onSubmit={handelApply}
          className=" mx-auto w-full md:w-2/3 px-4  md:px-10 mt-5 overflow-hidden rounded-lg space-y-5 py-5 drop-shadow-2xl bg-slate-100"
        >
