...
const MyCollege = () => {
  ...
  if (myCollege.email !== user?.email){
    return <>
      <div className="my-container mt-48 text-center ">
          <h2 className=" text-2xl md:text-4xl font-bold">You have not applied to any college</h2>
          <div className="mt-4 text-lg font-semibold">
            <p>Please go to admission page and Apply one college</p>
          </div>
      </div>
    </>
  }
